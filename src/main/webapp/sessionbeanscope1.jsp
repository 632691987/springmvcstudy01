...
<body>
<!-- 
http://localhost:8080/basic_xml/sessionbeanscope1.jsp
...
* session bean 起作用。
 -->
<form action="${pageContext.request.contextPath }/sessionbeanlogin" method="post">
	<table cellpadding="0" cellspacing="0" border="1" width="300px">
		<tr>
			<td width="150px">username</td>
			<td><input type="text" id="username" name="username" value="default username"></td>
		</tr>
		
		<tr>
			<td width="150px">password</td>
			<td><input type="text" id="password" name="password" value="default password"></td>
		</tr>
