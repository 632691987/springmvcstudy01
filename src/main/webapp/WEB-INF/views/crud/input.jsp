...
<body>
	...
	<!--  
		...
		若没有指定该属性，则默认从 request 域对象中读取 command 的表单 bean (modelAttributes 里面默认的名称叫 command, 这里叫 employee)
		如果该属性值也不存在，则会发生错误。
	-->
	<br><br>
	<form:form action="${pageContext.request.contextPath }/emp" method="POST" modelAttribute="employee">
		...
		Gender: 
		<br>
		<form:radiobutton path="gender" value="1" label="Male"/><br />
	...
	<script type="text/javascript">
		$( function() {$("#birth").datepicker({dateFormat: 'yy-mm-dd'});});
	</script>
</body>
</html>